...
const RegistroProveedor = async () => {
    ...
    try {
      const response = await axios.post('http://18.223.116.149/api/registrarProveedor',Proveedor);
  ...
  try {
  const response = await axios.post('http://18.223.116.149/api/TablaProveedor')
