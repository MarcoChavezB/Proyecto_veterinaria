...
export const deleteProd = defineStore('admin', () => {
  const state = {
    variable: '',
  };
...
export const deleteProdInter = defineStore('admin', () => {
  const state = {
    variable: '',
  };
...
export const showModalCard = defineStore('cita', () => {
  const state = {
    variable: '',
  };
...
export const showModalCardAcept = defineStore('cita', () => {
  const state = {
    variable: '',
  };
